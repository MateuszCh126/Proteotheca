    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-4">
        <div className="p-3 bg-white/5 rounded-xl border border-white/5">
          <span className="text-3xs uppercase tracking-wider text-slate-400 block mb-0.5">Accession</span>
          <span className="text-sm font-bold text-white font-mono">{uniprot.accession}</span>
        </div>
        <div className="p-3 bg-white/5 rounded-xl border border-white/5">
          <span className="text-3xs uppercase tracking-wider text-slate-400 block mb-0.5">Entry Name</span>
      ...
      <div className="space-y-1.5">
        <div className="flex justify-between items-center text-3xs uppercase tracking-wider text-slate-400">
          <span>Sequence ({uniprot.sequence.length} AA)</span>
        </div>
