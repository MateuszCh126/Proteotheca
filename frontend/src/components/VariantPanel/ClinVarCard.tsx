  ...
  return (
    <div className="p-4 bg-white/5 rounded-xl border border-white/5 space-y-3">
      <div className="flex items-center justify-between">
        <span className="text-3xs uppercase tracking-wider text-slate-400 font-bold">ClinVar Significance</span>
      ...
      <div className="space-y-1">
        <span className="text-3xs uppercase tracking-wider text-slate-500 block">Interpretation details</span>
